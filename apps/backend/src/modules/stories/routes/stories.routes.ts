...
import { validateCreateStory, validateStoryReply } from '../middleware/stories.validate.middleware';
import {
...
router.post('/:id/reply', socialActionRateLimitMiddleware, validateStoryReply, controller.replyToStory);
